                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="flex-column" data-kt-stepper-element="content">
                                            <div class="fv-row invoice">
                                                <label class=" form-label"><b>Müşteriye Kesilen Onarım Faturası
                                                        (Zorunlu)</b></label>
                                            ...
                                            <div class="fv-row mt-5 work_order">
                                            ...
                                            <div class="fv-row mt-5 consent">
                                                <label class=" form-label"><b>İmzalı Parça Rıza Beyanı
                                                        (Zorunlu)</b></label>
            ...
            /*if ($('#application_form').length > 0) {
                $('#application_form').on('submit', function (e) {
                    ...
                    const dropZones = [
                        {
                            id: '#dropZone1Input',
                            error: 'Müşteriye Kesilen Onarım Faturası alanına en az bir dosya ekleyin.'
                        },
