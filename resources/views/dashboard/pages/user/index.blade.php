                                        ...
                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                            ...
                                            <div class="branchSelectContainer" style="display: none;">
                                                <label for="branchSelect"
                                                    class="form-label fs-6 fw-semibold">Şube:</label>
                                                <select class="form-select form-select-solid fw-bold branchSelect"
                                                    name="branch">
                        ...
                        @forelse($Users as $user)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="{{ route('user.destroy', $user->uuid) }}"
                                        class="btn btn-danger btn-active-light-danger btn-flex btn-center btn-sm delete-user ms-2">Sil</a>
                                </td>
                            </tr>
                        @empty
                        @endforelse
