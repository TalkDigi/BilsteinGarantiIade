										...
										<div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-green.png" data-bs-theme="light">
											...
											<h3 class="card-title align-items-start flex-column text-white pt-15">
												...
												<div class="fs-4 text-white">
													<span class="opacity-75">Toplam {{$totalCount}} @if(auth()->user()->hasRole('Yönetici')) başvuru @else başvurunuz @endif var.</span>
												</div>
											</h3>
										</div>
										<!--end::Heading-->
												...
												<div class="row g-3 g-lg-6">
													...
													<div class="col-6">
														...
														<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
															...
															<div class="m-0">
																<!--begin::Number-->
																<span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$typeBCount}}</span>
																<!--end::Number-->
																<!--begin::Desc-->
																<span class="text-gray-500 fw-semibold fs-6">Masraf İçermeyen Başvuru</span>
																<!--end::Desc-->
															</div>
															<!--end::Stats-->
														</div>
													...
													<div class="col-6">
														...
														<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
															...
															<div class="m-0">
																<!--begin::Number-->
																<span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$typeCCount}}</span>
																<!--end::Number-->
																<!--begin::Desc-->
																<span class="text-gray-500 fw-semibold fs-6">Hasarlı / Eksik Parça</span>
																<!--end::Desc-->
															</div>
															<!--end::Stats-->
														</div>
													...
													<div class="col-12">
														...
														<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
															...
															<div class="m-0">
																<!--begin::Number-->
																<span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$typeACount}}</span>
																<!--end::Number-->
																<!--begin::Desc-->
																<span class="text-gray-500 fw-semibold fs-6">İlave Masraf İçeren Başvuru</span>
																<!--end::Desc-->
															</div>
															<!--end::Stats-->
														</div>
            ...
            <div class="col-xl-8">
                <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                    <div class="col-xl-3 mb-5 mb-xl-0">
                        <div class="card h-150px bgi-no-repeat bgi-size-cover bgi-position-y-center card-xl-stretch border-0" style="background-color: #F1416C;
background-image: url('assets/media/svg/shapes/wave-bg-red.svg');">
                            <div class="card-body p-6">
                                <a href="{{route('dashboard.guide.sss')}}" class="text-white text-hover-primary fw-bold fs-2" >Sıkça Sorulan Sorular</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-9">
                        <div class="card h-150px card-xl-stretch">
                            <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <a href="#" class="btn btn-primary fw-semibold" data-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication">+</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card h-175px bgi-no-repeat bgi-size-contain card-xl-stretch mb-5 mb-xl-8" style="background-color: #663259; background-position: right; background-image:url('assets/media/svg/misc/taieri.svg')">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <div class="m-0">
                                    <a href='{{route('dashboard.application.closure')}}' class="btn btn-danger fw-semibold px-6 py-3">Oluştur</a>
                                </div>
                            </div>
                        </div>
											...
											<div class="card card-flush h-lg-100">
												...
												<div class="card-body pt-5">
													@forelse($r as $a => $c)
                                                        ...
                                                        @else
                                                        <div class="d-flex flex-stack">
														<div class="text-gray-700 fw-semibold fs-6 me-2">{{$a}}</div>
                ...
                <div class="card card-xl-stretch">
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_654c7052771f0">
                                <div class="px-7 py-5">
                                ...
                                <div class="px-7 py-5">
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_654c7052771f0" data-allow-clear="true">
                                                <option></option>
