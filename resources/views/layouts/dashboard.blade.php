...
<head>
    ...
    <style>
        ...
        .formChangeInputs .form-check {
            flex: 1 1 50%;
            /* Her bir child div'in genişliği %50 olacak */
                            ...
                            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                                                        ...
                                                        @forelse($NonViewed as $item)
                                                            <div class="d-flex flex-stack py-4">
                                                                <div class="d-flex align-items-center me-2">
                                                                    <span
                                                                        class="w-70px badge badge-light-danger me-4">Okunmadı</span>
                                ...
                                <div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3"
                                    ...
                                    <div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px"
                                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                        data-kt-menu-placement="bottom-end">
                                        <div class="symbol-label h-30px w-30px rounded  fs-3 bg-light-primary text-primary text-uppercase"
                        ...
                        <div class="page-title d-flex flex-column me-3">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                                @if(auth()->user()->hasRole('Yönetici'))
                                    ...
                                    <li class="breadcrumb-item text-white opacity-75">
                                        <a href="{{route('test.delete.closure')}}"
                                            class="text-white text-hover-primary">(Test)
                                            Ay Kapamaları Sil</a>
                                    </li>
                                @endif
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-lg btn-primary"
                                        data-kt-stepper-action="next">Devam
                                        Et
                                        <i class="ki-duotone ki-arrow-right fs-3 ms-1 me-0">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            text: "Şube güncellenirken bir hata oluştu!",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Tamam",
                            customClass: {
                ...
                error: function () {
                    // Ajax hatası durumunda kullanıcıya bildir
                    Swal.fire({
