                ...
                <div class="container-xxl d-flex align-items-center">
                    ...
                    <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                        <a href="{{route('dashboard')}}">
                            <img alt="Logo" src="https://bilsteingroup.com/typo3conf/templates/main/assets/img/logo.svg"
                                 class="logo-default h-30px" style="filter: brightness(0) invert(1);"/>
                        </a>
                    </div>
                            ...
                            <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                ...
                                <div
                                    ...
                                    @forelse($MenuFile as $file)
                                        <a href="{{Storage::url('files/'.$file->path)}}" target="_blank"
                                           class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                                    <span class="menu-link py-3">
                        ...
                        <div class="topbar d-flex align-items-stretch flex-shrink-0">
                            @if(auth()->user()->hasRole('Yönetici'))
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    <div
                                        class="position-relative btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                        ...
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                            ...
                                            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">İncelenmemiş Başvurular
                                                <span class="fs-8 opacity-75 ps-3">{{count($NonViewed)}} Başvuru</span>
                                            </h3>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="kt_topbar_notifications_3"
                                                    ...
                                                    @forelse($NonViewed as $item)
                                                        <div class="d-flex flex-stack py-4">
                                                            <div class="d-flex align-items-center me-2">
                                                                ...
                                                                <a href="{{route('dashboard.application.show',['claim' => $item->claim_number])}}"
                                                                   class="text-gray-800 text-hover-primary fw-semibold">{{$item->claim_number}}</a>
                                                            </div>
                                                            <span
                                                                class="badge badge-light fs-8">{{$item->created_at->diffForHumans()}}</span>
                                                        </div>
                                                        @if($loop->iteration == 5)
                                                            @break
                                                        @endif
                                                ...
                                                <div class="py-3 text-center border-top">
                                                    <a href="{{route('dashboard.application.list')}}"
                                                       class="btn btn-color-gray-600 btn-active-color-primary">Tümünü
                                                        Görüntüle
                            ...
                            <div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3"
                                ...
                                <div
                                    ...
                                    data-kt-menu-placement="bottom-end">
                                    <div
                                        class="symbol-label h-30px w-30px rounded  fs-3 bg-light-primary text-primary text-uppercase"
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            <div class="symbol symbol-50px me-5">
                                                <div
                                                    class="symbol-label fs-3 bg-light-primary text-primary text-uppercase">
                                                    {{substr(auth()->user()->name,0,1)}}
                                                </div>
                                            </div>
                            ...
                            <div class="tab-content rounded h-100 bg-light p-10">
                                <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-gray-700 flex-grow-1">Analytics Module</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-muted flex-grow-1">Accounting Module</span>
                                            <i class="ki-duotone ki-cross-circle fs-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-muted flex-grow-1">Network Platform</span>
                                            <i class="ki-duotone ki-cross-circle fs-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="fw-semibold fs-5 text-muted flex-grow-1">Unlimited Cloud Space</span>
                                            <i class="ki-duotone ki-cross-circle fs-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_advanced">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-gray-700 flex-grow-1">Finance Module</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-gray-700 flex-grow-1">Accounting Module</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_enterprise">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-gray-700 flex-grow-1">Network Platform</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_custom">
                                    ...
                                    <div class="pt-1">
                                        <div class="d-flex align-items-center mb-7">
                                            <span
                                                class="fw-semibold fs-5 text-gray-700 flex-grow-1">Unlimited Users</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
														<span class="d-flex align-items-center me-2">
															...
															<span class="d-flex flex-column">
																<span
                                                                    class="fw-bold fs-6">Face to Face Discussions</span>
                                        ...
                                        <label class="d-flex flex-stack cursor-pointer">
													<span class="d-flex align-items-center me-2">
														...
														<span class="d-flex flex-column">
															...
															<span
                                                                class="fs-7 text-muted">Microsoft Fast NoSQL Database</span>
														</span>
													</span>
                                            <span class="form-check form-check-custom form-check-solid">
														<input class="form-check-input" type="radio" name="dbengine"
...
<script>
    ...
    const check_quantity = "{{route('dashboard.application.quantity_check')}}";
</script>
